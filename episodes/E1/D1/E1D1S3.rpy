label E1D1S3:
    ...
    "Это место отличается от уютной, но тесной квартиры, которую я ожидал. Вместо этого, я чувствую, что только что вошел в обложку журнала домашнего декора."
    ...
    "Я притянул ближайшую коробку и открыл её. Там просто одежда. Может начать из неё выкладвать."
    ...
    menu:
        "ОМ НОМ НОМ!":
            if (E1D1S3_mcdoesntlikesushi == 0):
                "Я жадно тянулся за добавкой, даже после того, как Никки и Кайто отложили свои палочки для еды."
                ...
                "Я съел последний кусочек и довольно вздохнул."
                ...
                "Я съел последний кусочек и подавил отрыжку."
        ...
        "Я тоже наелся...":
            ...
            "Kaito съел последний кусок суши и омыл его зеленым чаем."
            show note:
                xoffset 1040
                yoffset 5
                xzoom .75
    ...
    "Кайто откинулся на спинку стула, положив руки за голову."
    voice "audio/voice/E1/D1/S3/Kaito/15.ogg"
    hk "Ну, как тебе жизнь в CINY?"
    
    pf "Как обычно. Жкзамены, грязная комната общежития, подработка."
    
    show nikki hap at l2
    voice "audio/voice/E1/D1/S3/Nikki/7.ogg"
    sf "И ты все же смог накопить денег на покупку мотоцикла."
    ...
    "Он дал каждому из нас SIM карту."
    ...
    hk "А ты позаботился о бумагах о переводе?"
    ...
    "Немного подождав, телефон включился, показав пустой лист контактов. Я бысто обменялся телефонами с Никки и дядей Кайто. Старые контакты я могу добавить позже."
