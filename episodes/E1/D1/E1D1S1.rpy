label E1D1S1:
    ...
    menu:
        ...
        "О каком это ещё *сне* ты говоришь?":
            ...
            pf "Как такая маленькая девочка может извадать такой {i}громкий{/i} шум?"
            show nikki wor
            voice "audio/voice/E1/D1/S1/Nikki/7.ogg"
            sf "О Боже, Я больше никогда не смогу показать лицо на людях! Долгие поездки будут казаться ещё более долгими, если я не смогу поспать! А что насчёт ночёвок? Как я вообще найду парня?"
        ...
        "*Ворчать*":
            "Скрестив руки на груди, Я опустился на свое место и начал бормотать себе под нос. Если бы я спал, это было бы грубым пробуждением, поэтому я считаю, что имел право быть немного сердитым."
            ...
            pf "Гррр…"
            "Никки лучилась улыбкой в моём направлении. По крайней мере, один из нас наслаждается этим."
    

    "Солнце светило в глаза, привлекая внимание. {w}Небо пылало красно-оранжевым цветом, пока солнце ползло к его отражению на сверкающем океане. {w}Лёгкий бриз колыхал деревья за пределами побережья. Кажется, что листья прощались с нами по мере того, как мы проезжали мимо." 
    ...
    "На ее губах была улыбка, но ее теплые глаза искали мои. Через мгновение она опустила глаза и опустилась обратно в кресло." 
    ...
    menu:
        "Отлично! Тогда я возвращаюсь.":
            ...
            sf "Ах!? Эмм..."
            "Её глаза округлились, и она закусила губу, пытаясь скрыть беспокойство." 
        ...
        "Кто-то должен позаботиться о тебе.":
            ...
            "Легко забыть, что она уже не та маленькая девочка, которая притворяется больной, потому что слишком нервничает, чтобы пойти в  свой первый день в школу. {w}Мы только что были вырваны из единственной жизни, которую знали, но Никки - воплощение спокойствия, пока ждёт остановки поезда."
            pf "Никки…"
            hide nikki with dissolve
            $renpy.pause(.25)
