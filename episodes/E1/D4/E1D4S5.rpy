    ...
    if (E1D4S4_FollowMatchPlan == 1):
        ...
        menu:
            ...
            "Всегда пожалуйста.":
                ...
                ki "Дело не в этом!"
                show kaori ann at r3
                pf "Вообще-то, как раз-таки в этом. Такой каламбур."
        ...
        "Сё подошёл к каори, пытаясб успокоить её, а Маю отошла назад, пристально глядя на землю."
        ...
        ki "Ты {i}не сделал{/i} то, что было лучше для команды. Ты сделал то, что было лучше для тебя, а Сё и Маю поплатились за твои действия. Ты возможно и заработал нам очков, но мы бы заработали больше, если бы половина команды не была разбита."
